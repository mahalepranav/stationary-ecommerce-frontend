            ...
            <div className='w-full max-w-3xl'>
                {
                    loading ? (
                        loadingCart?.map((el,index)=>{
                            return(
                                <div key={el+"Add To Cart Loading"+index} className='w-full bg-slate-200 h-32 my-3 border border-slate-300 animate-pulse rounded'></div>
                            )
                        })
                    ) : (
                                ...
                                <div key={product?._id+"Add To Cart Loading"} className='w-full bg-white h-32 my-3 border border-slate-300 rounded grid grid-cols-[128px,1fr]'>
                                    ...
                                    <div className='px-4 py-2 relative'>
                                        ...
                                        <div className='flex items-center gap-3 mt-1'>
                                            <button className='border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white w-6 h-6 flex justify-center items-center rounded' onClick={()=>decreaseQty(product?._id,product?.quantity)}>-</button>
            ...
            <div className='mt-5 lg:mt-0 w-full max-w-sm'>    
                {
                    loading ? (
                        ...
                        <div className='h-36 bg-white'>
                            ...
                            <button className='bg-green-600 p-2 text-white w-full'>Payment</button>
                        </div>
                    )
                }
            </div>
