  ...
  return (
    <div>
      <div className='bg-white py-2 px-4 flex justify-between items-center'>
        ...
        <button className='border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white transition-all py-2 px-3 rounded-full' onClick={()=>setOpenUploadProduct(true)}>Upload Product</button>
      </div>
